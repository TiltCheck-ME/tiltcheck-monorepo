...
export interface TiltSignal {
  userId: string;
  signalType: 'loss-streak' | 'bet-escalation' | 'message-sentiment' | 'rapid-losses' | 'cooldown-violation' | 'rapid-messages' | 'caps-spam' | 'rage-quit' | 'loan-request' | 'ai-detected' | 'bet-sizing' | 'bad-beat';
  severity: number; // 0-5
