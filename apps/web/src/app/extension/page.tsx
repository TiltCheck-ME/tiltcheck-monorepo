...
export default function ExtensionPage() {
  return (
    <div className="container mx-auto px-4 py-24 text-center max-w-5xl">
        <h1 className="neon neon-main text-4xl md:text-5xl mb-6" data-text="THE SURVEILLANCE LAYER">
        ...
        <div className="stepper-vertical max-w-4xl mx-auto text-left space-y-12">
          <div className="stepper-item active relative pl-12 border-l border-[#283347]" aria-current="step">
            ...
            <h2 className="text-2xl font-black uppercase tracking-tight text-white mb-2">INITIALIZE_SENTRY</h2>
          ...
          <div className="stepper-item relative pl-12 border-l border-[#283347]">
            ...
            <h2 className="text-2xl font-black uppercase tracking-tight text-white mb-2">TELEMETRY_AUDIT</h2>
            <p className="text-gray-400 text-sm leading-relaxed">
          ...
          <div className="stepper-item relative pl-12 border-l border-[#283347]">
            ...
            <h2 className="text-2xl font-black uppercase tracking-tight text-[#17c3b2] mb-2">REDEEM_TO_WIN</h2>
            <p className="text-gray-400 text-sm leading-relaxed">
