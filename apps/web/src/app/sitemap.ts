...
const PAGES: Array<{ url: string; changeFrequency: MetadataRoute.Sitemap[number]['changeFrequency']; priority: number }> = [
  ...
  { url: '/operators',                  changeFrequency: 'weekly',  priority: 0.7 },
  { url: '/operators/keys',             changeFrequency: 'weekly',  priority: 0.6 },
  { url: '/operators/pricing',          changeFrequency: 'monthly', priority: 0.6 },
