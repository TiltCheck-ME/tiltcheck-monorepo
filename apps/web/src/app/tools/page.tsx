...
const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    description: 'Track cooldowns, log weekly wager and P/L, reverse-engineer reload math, and catch bonuses that land suspiciously light.',
    status: 'live',
  },
  {
    ...
    description: 'Send SOL tips to other degens via Discord username from the web UI. Non-custodial — keys never leave your wallet. Direct sends and room rain are both wired.',
    status: 'live',
  },
  {
    ...
    description: 'Lock profits behind a timer, manage releases, and update your redeem threshold from the web UI. Non-custodial. You set the line, the lock protects the bag.',
    status: 'live',
  },
  {
    ...
    description: 'Add and manage accountability partners from the web UI. Buddies get support-only alerts when your session goes sideways. No bankroll sharing, no money asks.',
    status: 'live',
  },
  {
    href: '/tools/geo-laws',
