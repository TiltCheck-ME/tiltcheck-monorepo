          ...
          <div className="terminal-box border-[#17c3b2] animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="mt-6 space-y-6">
              ...
              <button
                ...
                onClick={() => { if (feeAcknowledged) window.open('https://discord.gg/gdBsEJfCar', '_blank'); }}
              ...
              <p className="text-[10px] text-gray-600 font-mono text-center uppercase tracking-widest -mt-2">
                Web tipping coming soon. Opens Discord — use /juicedrop for instant drops.
              </p>
            </div>
          </div>
        )}
      ...
      {hasAccepted && (
        <div className="mt-8 flex items-center gap-2">
          <span className="text-[10px] text-gray-600 font-mono tracking-widest">
            NON-CUSTODIAL PROTOCOL // YOUR KEYS. YOUR PROBLEM.
          </span>
        </div>
      )}
    </main>
