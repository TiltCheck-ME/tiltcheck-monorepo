...
export const features: Tool[] = [
  ...
  },
  {
    ...
    icon: "rng-audit.svg",
    category: "RNG AUDIT",
    title: "RNG & RTP Parity Audit",
    description: "API-level drift detection. We cryptographically verify the casino's server hashes to ensure the math isn't shadow-nerfed.",
    status: "live",
    gridClasses: "",
  },
  {
