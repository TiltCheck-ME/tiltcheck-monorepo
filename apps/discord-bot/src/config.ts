...
export const config: BotConfig = {
  ...
  discordToken: process.env.TILT_DISCORD_BOT_TOKEN || process.env.TIP_DISCORD_BOT_TOKEN || getDiscordToken(),
  clientId: process.env.TILT_DISCORD_CLIENT_ID || process.env.TIP_DISCORD_CLIENT_ID || getEnvVar('DISCORD_CLIENT_ID', false),
